...
public class PlayerThree extends Player{
    ...
    public void setPos(Input input) {
        double new_X = pos.x;
        double new_Y = pos.y;
        if (input.isDown(Keys.Y)) {
            new_Y -= 10;
        }
        if (input.isDown(Keys.G)) {
            new_X -= 10;
        }
        if (input.isDown(Keys.H)) {
            new_Y += 10;
        }
    ...
    public void moveCharacter(Input input) {
        if ((input.isDown(Keys.Y)) && (input.isDown(Keys.G))) {
            getCharacter().move("WA");
        }
        else if ((input.isDown(Keys.Y)) && (input.isDown(Keys.J))) {
            getCharacter().move("WD");
        }
        else if ((input.isDown(Keys.H)) && (input.isDown(Keys.G))) {
            getCharacter().move("SA");
        }
        else if ((input.isDown(Keys.H)) && (input.isDown(Keys.J))) {
            getCharacter().move("SD");
        }
        else if (input.isDown(Keys.J)) {
            getCharacter().move("D");
        }
        else if (input.isDown(Keys.Y)) {
            getCharacter().move("W");
        }
        else if (input.isDown(Keys.G)) {
            getCharacter().move("A");
        }
